...
public class UserInterfaceInfoEsDTO implements Serializable {
     ...
     * @return
     */
    public static UserInterfaceInfoEsDTO objToDto(InterfaceInfo interfaceInfo) {
        if (interfaceInfo == null) {
            return null;
        }
        UserInterfaceInfoEsDTO interfaceInfoEsDTO = new UserInterfaceInfoEsDTO();
     ...
     * @return
     */
    public static InterfaceInfo dtoToObj(UserInterfaceInfoEsDTO interfaceInfoEsDTO) {
